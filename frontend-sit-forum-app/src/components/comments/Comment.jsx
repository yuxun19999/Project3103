...
import { FiMessageSquare, FiEdit3, FiTrash } from "react-icons/fi"
...
const Comment = ({ comment, logginedUserId, affectedComment, setAffectedComment, addComment, parentId = null, updateComment, deleteComment, replies, }) => {
    ...
    // user login must be equal to the comment user id
        ...
        <div className="flex flex-nowrap items-start gap-x-3 bg-[#F2F4F5] p-3 rounded-lg">
            ...
            <div className="flex-1 flex flex-col">
                ...
                <span className="text-xs text-dark-light">
                    {new Date(comment.createdAt).toLocaleDateString("en-SG", {
