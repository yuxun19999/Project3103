            ...
            {item.type === "link" ? (
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div
                        ...
                        <ul className="bg-dark-soft lg:bg-transparent lg:bg-white text-center flex flex-col shadow-lg rounded-lg overflow-hidden">
    ...
    return (
        <section className="sticky top-0 left-0 right-0 z-50 bg-white">
            <header className="container mx-auto px-5 flex justify-between py-4 items-center">
                <Link to="/">
                    <img className="w-16" src={images.SITLogo} alt="SIT Forum" style={{ width: '100px', height: '60px' }} />
                </Link>
                ...
                >
                    ...
                    {userState.userInfo ? (<div className="text-white items-center gap-y-5 lg:text-dark-soft flex flex-col lg:flex-row gap-x-2 font-semibold">
                    ...
                    </div>) : (<button onClick={() => navigate("/login")} className="mt-5 lg:mt-0 border-2 border-blue-500 px-6 py-2 rounded-full text-blue-500 font-semibold hover:bg-blue-500 hover:text-white transition-all duration-300">
                        Sign in</button>)}
