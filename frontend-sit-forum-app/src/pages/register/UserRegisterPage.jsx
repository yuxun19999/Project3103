...
const UserRegisterPage = () => {
    ...
    // WATCH IS TO WATCH FOR THE PASSWORD INPUT IS FOR LATER ON CONFIRM PASSWORD VALIDATE USE
                ...
                <form onSubmit={handleSubmit(submitHandler)}>
                    ...
                    <div className="flex flex-col mb-6 w-full">
                        ...
                        <input type="password" id="confirmPassword"
                            ...
                            placeholder="Re-enter Password" className={`placeholder:text-[#959ead] text-dark-hard mt-3 rounded-lg px-5 py-4 font-semibold block outline-none ${errors.confirmPassword ? "border border-red-500" : "border border-[#c3cad9]"}`} />
