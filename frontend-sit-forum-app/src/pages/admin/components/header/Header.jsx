...
const Header = () => {
    ...
    //default falls on dashboard page
    ...
    return (
        ...
        <header className="flex h-fit item justify-between p-4 lg:h-full lg:max-w-[300px] lg:flex-col lg:items-start lg:justify-start lg:p-0">
            {/* logo */}
            <Link to="/">
                <img src={images.SITLogo} alt="logo" className="w-16 lg:hidden" />
            </Link>
            ...
            {isMenuActive && (
                <div className="fixed inset-0 lg:static lg:h-full lg:w-full">
                    ...
                    <div className="fixed top-0 bottom-0 left-0 z-50 w-3/4 overflow-y-auto bg-white p-4 lg:static lg:h-full lg:w-full lg:p-6">
                        <Link to={'/'}>
                            <img src={images.SITLogo} alt="logo" className="w-16" />
                        </Link>
